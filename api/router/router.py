...
from schemas.schemas import FileUpload,EmailFile,SendEmail,FilePath,Prompt
...
from services.crawler import crawler, final_output , extract
...
def send_registration_form(data: SendEmail):
    ...
    Sincerely,
    Your Company Name"""
    return send_email_with_attachment(subject,body,data.emails,"api/forms/registration form.pdf")
...
def send_RFP_form(data: SendEmail):
    ...
    Sincerely,
    Your Company Name"""
    return send_email_with_attachment(subject,body,data.emails,"api/forms/RFP.pdf")
...
def matrix_generator_from_RFP(data: FilePath):
    ...
    matrix = final_output(extracted_data, llm_formatted_data)
    print("matrix ----------------------------",matrix)
    return matrix