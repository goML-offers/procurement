...
reg_vector_store = os.path.join(current_directory, 'reg_vectore_store/.lancedb')
rfp_vector_store = os.path.join(current_directory, 'rfp_vectore_store/.lancedb')
...
async def upload_files(files: list[UploadFile] = File(...)):
    ...
    try:
        ...
        # if os.path.exists(reg_vector_store):
...
async def upload_files(files: list[UploadFile] = File(...)):
    ...
    try:
        # Create the upload folder if it doesn't exist
        rfp_file_path.clear()
        # if os.path.exists(rfp_vector_store):
