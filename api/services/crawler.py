...
def aws_claude_summarisation(payload):
    ...
    # print(text)
    summary="provide me only the company name and the certification name or any award mentioned and the annual revenue from the text that is provided. if name of the company or certification name or the annual revenue is not present return me with 'N/A' dont provide me anything else"
    body_json = {
    "prompt": f"Human: {summary} {text} give me output in the form of a JSON like structure. "
              f"The structure of the output should look like this only, for example: "
              f"{{'company_name': 'ABC Corporation', 'certification': 'ISO certified', 'annual_revenue': '$23243434'}}"
...
def extract_data(input_text):
    ...
    for section in sections:
        ...
        if len(parts) == 2:
            ...
            # Handle lines without the delimiter
...
list_dict = [{'company_name': 'Saigon Technology', 'cost': '227,250', 'website': 'https://saigontechnology.com/', 'time': 'N/A'}, {'company_name': 'aalpha', 'cost': '200', 'website': 'https://www.aalpha.net/', 'time': 'N/A'}, {'company_name': 'microsoft', 'cost': '800', 'website': 'https://www.microsoft.com/investor/reports/ar22/', 'time': 'N/A'}] 
...
# extract_data = extract(crawler_result)

# llm_result = [{'vendor_name': 'Saigon Technology', 'cost': 'N/A', 'website': 'https://www.abccorp.com', 'time': '5 Days'}, {'vendor_name': 'XYZ Builders Inc.', 'cost': 'N/A', 'website': 'https://www.xyzbuilders.com', 'time': '3 Days'}, {'vendor_name': 'goml', 'cost': 'N/A', 'website': 'https://www.xyzbuilders.com', 'time': '3 Days'}]
...
def final_output(crawler_result, llm_result):
    ...
    print(result_list)
    return result_list
# final_output(extract_data, llm_result)
