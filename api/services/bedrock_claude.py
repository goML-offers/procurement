...
region_name = "us-east-1"#os.environ.get("region_name")
...
def aws_claude_summarisation(payload):
    ...
    prompt=f"""Human: {summary} {text} give me output in the form of a list of JSON. "
              ...
              "[{{'company_name': 'ABC Corporation', 'cost': '324', 'website': 'https://www.abccorp.com', 'timeline': '3months'}}, "
              "{{'company_name': 'XYZ Builders Inc.', 'cost': '34', 'website': 'https://www.abccorp.com', 'timeline': '2months'}}] "
              "this is just an example for two companies. Give me output in the exact structure for all the companies mentioned in the text provided. "
              "One dictionary for one company and add it to the list. Don't give me anything apart from a list of dictionaries Assistant:","""
    print("\n\n2")
